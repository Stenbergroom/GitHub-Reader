...
public class DBHelper extends SQLiteOpenHelper {
    ...
    public static final String CREATE_TABLE_USERS = "create table "+TABLE_USERS+" ("+"_id integer primary key autoincrement, "
            +COLUMN_USERS_LOGIN+" text, "+COLUMN_USERS_COMPANY+" text, "+COLUMN_USERS_FOLLOWERS+" integer, "
            +COLUMN_USERS_FOLLOWING+" integer, "+COLUMN_USERS_AVATAR_URL+" text);";
    ...
    public static final String CREATE_TABLE_REPOSITORIES = "create table "+TABLE_REPOSITORIES+" ("+"_id integer primary key autoincrement, "
            +COLUMN_REPOSITORIES_NAME+ " text, "+COLUMN_REPOSITORIES_LANGUAGE+" text, "+COLUMN_REPOSITORIES_FORKS+" integer, "
            + COLUMN_REPOSITORIES_WATCHERS+" integer);";
